          ...
          <div className="flex items-center gap-2">
            {(tab === 'registrations' || tab === 'participants') && (
              <button
                ...
                className="flex cursor-pointer select-none items-center gap-1.5 rounded-lg border border-slate-600 px-3 py-1.5 text-xs text-slate-300 transition-colors hover:bg-slate-800 hover:text-white active:bg-slate-800"
