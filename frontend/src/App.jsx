              ...
              >
                ...
                {/* 4-column grid */}
                  ...
                  <div className="col-span-2 md:col-span-1 space-y-4">
                    ...
                    <div className="font-mono text-vibranium/30 text-[10px] tracking-widest uppercase">March 15–16, 2026</div>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-3">
                      {[
                        { icon: '📍', text: 'Main Campus Arena', sub: 'Dept. of Computer Science' },
                        { icon: '📅', text: 'March 15–16, 2026', sub: '9:00 AM onwards' },
                        { icon: '📧', text: 'cystech@college.edu', sub: 'General queries' },
                        { icon: '📞', text: '+91 98765 10000', sub: 'Event coordinator' },
                      ].map(({ icon, text, sub }) => (
